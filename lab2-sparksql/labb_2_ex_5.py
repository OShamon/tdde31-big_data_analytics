...
stations_Ostergotland = stations_Ostergotland.registerTempTable("stations_Ostergotland").show()
...
precipitation_readings = precipitation_readings.registerTempTable("precipitation_readings")
